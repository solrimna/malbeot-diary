...
function ensureAppFeedbackUi() {
    let toastContainer = document.getElementById("alarm-toast-container");
    if (!toastContainer) {
        toastContainer = document.createElement("div");
        toastContainer.id = "alarm-toast-container";
        toastContainer.className = "alarm-toast-container";
        toastContainer.setAttribute("aria-live", "polite");
        toastContainer.setAttribute("aria-atomic", "true");
        document.body.appendChild(toastContainer);
    }

    let confirmModal = document.getElementById("alarm-confirm-modal");
    if (!confirmModal) {
        confirmModal = document.createElement("div");
        confirmModal.id = "alarm-confirm-modal";
        confirmModal.className = "alarm-feedback-modal hidden";
        confirmModal.setAttribute("role", "dialog");
        confirmModal.setAttribute("aria-modal", "true");
        confirmModal.setAttribute("aria-labelledby", "alarm-confirm-title");
        confirmModal.innerHTML = `
            ...
            <div class="alarm-feedback-card">
                ...
                <p id="alarm-confirm-message" class="alarm-feedback-message">정말 진행할까요?</p>
